...
public class ScheduledTestController {
    ...
    public void createScheduledTest(@RequestParam("name") String name,
        ...
        testExecutionManager.createScheduledTest(name, getProperties(properties), storageService.store(suites), cronExpression);
    }
    ...
    public void createRepeatingTest(@RequestParam("name") String name,
        ...
        logger.info("Scheduling test");
        testExecutionManager.createRepeatingTest(name, getProperties(properties), storageService.store(suites));
    }
