...
public class OptionTemplateOperationsTest {
    ...
    public void testHiloOptionConfigurationCreation() {
        ...
        checkShortTermHiloDuration(TagOperations.TagName.NO_CATEGORY, null);
        checkShortTermHiloDuration(TagOperations.TagName.SHORT_TERM_30_SEC_GAME_H3_TEXT, 30);
        checkShortTermHiloDuration(TagOperations.TagName.SHORT_TERM_60_SEC_GAME_H3_TEXT, 60);
        checkShortTermHiloDuration(TagOperations.TagName.SHORT_TERM_2_MIN_GAME_H3_TEXT, 120);
